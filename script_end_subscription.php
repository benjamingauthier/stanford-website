                                                    ...
                                                    <tr>
                                                        <td style='vertical-align: top; text-align: left; padding: 0; margin: 0;'>
                                                            <p style='font-family: 'Lato'; font-weight: normal; font-size: 15px; line-height: 20px; color: #595959; margin-top: 0px; margin-left: 0; margin-bottom: 15px; margin-right: 0; padding: 0; text-align:justify;'>
                                                                ...
                                                                <br />
                                    <span> Votre inscription sur STANDiO est confirmée ! Réalisez dès à présent votre site web en suivant ce lien : <a href='http://app.".$ndd.".mink.so' style='color: #f1c40f' onmouseover='this.style.color='#000000';' onmouseout='this.style.color='#f1c40f';'>app.".$ndd.".mink.so</a>. Votre PASSCODE est iloverespond<br><br>

                                      Nous procédons actuellement à l'enregistrement de votre nom de domaine. Vous pouvez cependant commencer à créer votre site, nous transférerons automatiquement vce dernier sur votre nom de domaine une fois son dépot effectué.
<br>
									</span>
                                                            <p>
                                                            </p>
